...
export function datosEjemplo(): BaseDatos {
  ...
  const tareas: BaseDatos['tareas'] = [
    {
      id: 'tar_demo_1',
      proyectoId: 'pro_demo_1',
      corteId: 'cor_demo_2',
      titulo: 'Importador de tarifas de proveedor',
      detalle: 'Leer el CSV del proveedor y proponer los cambios de coste antes de aplicarlos.',
      estado: 'desarrollando',
      prioridad: 'alta',
      importe: 380,
      fechaObjetivo: sumarDias(h, 5),
      orden: 1,
      creadoEn: ahora,
    },
    {
      ...
      proyectoId: 'pro_demo_1',
      corteId: 'cor_demo_2',
      titulo: 'Filtro por proveedor en el listado',
      estado: 'completada',
      prioridad: 'normal',
      importe: 150,
      fechaObjetivo: sumarDias(h, -1),
      orden: 2,
      creadoEn: ahora,
    },
    {
      id: 'tar_demo_3',
      proyectoId: 'pro_demo_1',
      titulo: 'Corregir el redondeo del IVA en la ficha',
      detalle: 'Reportado por el equipo de tienda: descuadra un céntimo en algunos productos.',
      estado: 'subida',
      prioridad: 'alta',
      importe: 90,
      fechaSubida: sumarDias(h, -4),
      orden: 3,
      creadoEn: ahora,
    },
    {
      id: 'tar_demo_4',
      proyectoId: 'pro_demo_1',
      titulo: 'Exportar el catálogo a CSV',
      estado: 'pendiente',
      prioridad: 'normal',
      importe: 220,
      orden: 4,
    ...
    },
    {
      id: 'tar_demo_5',
      proyectoId: 'pro_demo_1',
      titulo: 'Revisar textos de la ayuda',
      estado: 'pendiente',
      prioridad: 'baja',
      orden: 5,
      creadoEn: ahora,
    },
    {
      id: 'tar_demo_6',
      proyectoId: 'pro_demo_3',
      titulo: 'Actualizar plugins y núcleo',
      estado: 'desarrollando',
      prioridad: 'normal',
      importe: 120,
      fechaObjetivo: sumarDias(h, 2),
      orden: 1,
      creadoEn: ahora,
    },
  ];
